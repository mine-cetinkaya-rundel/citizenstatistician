...
![RStudio Cloud workspace with two projects](/post/2020-05-03-dipping-my-toes-in-generative-art-with-my-sister_files/rstudio-cloud.png)
...
![Setup for Zoom meeting with screen sharing](/post/2020-05-03-dipping-my-toes-in-generative-art-with-my-sister_files/virtual-setup.jpg){width="90%"}
...
We didn't spend a whole lot of time trying to understand the function code (that's something I might delve into at a later time) but we modified the examples slightly by changing input parameter and colour palettes.
...
![Using Notion to track resources and ideas for our learning](/post/2020-05-03-dipping-my-toes-in-generative-art-with-my-sister_files/notion.png){width=90%}
