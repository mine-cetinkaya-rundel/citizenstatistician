...
replies %>%
  ...
  summarise(across(tom_hanks:spring_break, sum, .names = "n_{.col}")) %>%
  mutate(across(n_tom_hanks:n_spring_break, ~ . / nrow(replies), .names = "p_{.col}"))
```
