---
title: 'Open-source contributions: an opportunity to teach, an opportunity to give back'
...
At the end of the last semester, on the last video of my Introduction to Data Science course, I told my students I'd be happy to work with them on a project the following semester. One of the projects I had in mind was updating this package. One of my students, Nicholas Goguen-Compagnoni, expressed interest in this project and now [he's a contributor to the package](https://github.com/dgrtwo/unvotes/blob/7eb7034314ff79c49c9e0785fcd9d216fa04cf14/DESCRIPTION#L6)! 
...
- They learn to work with Git and GitHub, specifically commiting, pushing, pulling, and resolving merge conflicts. They don't learn about branches or pull requests. 
...
The first "homework" was to figure out if it's even feasible to update the package, which would mean finding more recent data on United Nationa voting history. 
...
One of the packages I maintain is [openintro](http://openintrostat.github.io/openintro) and we had a [documentation related issue](https://github.com/OpenIntroStat/openintro/issues/15) sitting there for a while. So I asked Nicholas to work on that issue following the workflows he recently learned about and to make a [pull request](https://github.com/OpenIntroStat/openintro/pull/37). Then, in our next meeting, I reviewed the pull request while sharing my screen and talking through my feedback as I put it in. After our meeting Nicholas took another few days to work through the review comments and we succesfully merged the pull request and closed the issue.
...
The next step was to work on the actuall problem (updating the data) but we weren't quite ready to make the actual pull request yet.
...
Finally, Nicholas put in the [pull request to the original unvotes repo](https://github.com/dgrtwo/unvotes/pull/2) and after a round of review, the package was ready to go!
...
This project was very fun for me to work on for a variety of reasons. I love working with students and, as someone who tends to teach larger courses, don't end up having many opportunities to work one-on-one with them. I also had been meaning to work on this for a while, but it kept dropping off my priority list, and finally it got done! Not only was this an opportunity to contribute back to an open-source project that I benefitted so much from, it was also a great way to turn this into an educational project! 
